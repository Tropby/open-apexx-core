...
class ReadPM extends \PublicAction
{
	public function execute()
	{
		...
		if (!$res['id']) die('you can only read your own messages!');
		...
		if ($res['userid'] != $user->info['userid']) $db->query("UPDATE " . PRE . "_user_pms SET isread='1' WHERE id='" . $_REQUEST['id'] . "' LIMIT 1");
	}
}
