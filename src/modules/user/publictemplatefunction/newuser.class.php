...
class NewUser extends \PublicTemplateFunction
{
    public function execute($count = 5, $template = 'newuser')
    {
        ...
        $this->publicModule()->call('print', array ($data, 'functions/' . $template, 'NEW') );
    }
}
